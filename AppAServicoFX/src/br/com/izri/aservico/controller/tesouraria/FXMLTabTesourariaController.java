...
public class FXMLTabTesourariaController extends ControllerBase implements Initializable {

	private static FXMLTabTesourariaController instance;

	public static FXMLTabTesourariaController getInstance() {
		if (FXMLTabTesourariaController.instance == null) {
			FXMLTabTesourariaController.instance = new FXMLTabTesourariaController();
		}

		return FXMLTabTesourariaController.instance;
	}

	public FXMLTabTesourariaController() {
	...
	public void buscarNomesMembros() {
		...
		listaMembros = this.getMembroDAO().pesquisarMembro("", null);
	...
	public void initialize(URL url, ResourceBundle resource) {
		...
		this.getCampoValor().textProperty().addListener(new ChangeListener<String>() {
			...
			public void changed(ObservableValue<? extends String> observable, String oldValue, String newValue) {
				MascarasFX.mascaraReal(FXMLTabTesourariaController.this.getCampoValor());
			}
		});
		...
		this.getCampoObservacao().textProperty().addListener(new ChangeListener<Object>() {
			...
			public void changed(ObservableValue<?> observable, Object oldValue, Object newValue) {
				FXMLTabTesourariaController.this.getCampoObservacao().setScrollTop(Double.MIN_VALUE);
			}
		});
